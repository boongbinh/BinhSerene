using MyRepository = BinhSerene.Administration.Repositories.UserPermissionRepository;
using MyRow = BinhSerene.Administration.UserPermissionRow;

namespace BinhSerene.Administration.Endpoints;
